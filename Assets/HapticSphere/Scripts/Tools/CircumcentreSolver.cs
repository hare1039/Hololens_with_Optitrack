...
public class CircumcentreSolver
{
	...
	/// <summary>
	/// The centre of the resulting SphereUI.
	/// </summary>
	...
	/// <summary>
	/// The radius of the resulting SphereUI.
	/// </summary>
	...
	/// <summary>
	/// Whether the result was a valid SphereUI.
	/// </summary>
	public bool Valid
	{
	...
	/// <summary>
	/// Computes the centre of a SphereUI such that all four specified points in
	/// 3D space lie on the SphereUI's surface.
	/// </summary>
	...
	{		
		this.Compute(vec2Array(a), vec2Array(b), vec2Array(c), vec2Array(d));
	}
	...
	private double[] vec2Array(Vector3 v){
